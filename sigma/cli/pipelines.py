...
pipelines = {
    ...
    "ecs_windows": Pipeline(ecs_windows, ("elasticsearch", "opensearch", "matano")),
    "ecs_windows_old": Pipeline(ecs_windows_old, ("elasticsearch", "opensearch", "matano")),
    "ecs_zeek_beats": Pipeline(ecs_zeek_beats, ("elasticsearch", "opensearch", "matano")),
    "ecs_zeek_corelight": Pipeline(ecs_zeek_corelight, ("elasticsearch", "opensearch", "matano")),
